            ...
            <jsp:include page="header.jsp"></jsp:include>
                <div id="page-wrapper">
                    <div class="main-page">
                        <div class="forms">
                            <div class="row">
                                <h3 class="title1">Thêm Lịch Trình</h3>
                                <div class="form-three widget-shadow">
                                    <form class="form-horizontal" action="${pageContext.request.contextPath}/admin/lichtrinh/insert" 
                                      method="POST">
                                    <div class="form-group">
                                        <label for="focusedinput" class="col-sm-2 control-label">Tên Lịch Trình:</label>
                                        <div class="col-sm-8">
                                            <input  type="text" class="form-control1" id="focusedinput" placeholder="Nhập Tên Lịch Trình" name="tenLichTrinh" maxlength="100" value="${tenlichtrinh}">
                                        </div>
                                        <div class="col-sm-2">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="number" class="form-control1" id="focusedinput"  name="giaVe" maxlength="100" value="0">
                                        </div>
                                        <div class="col-sm-2">
                                                ...
                                                <td>
                                                    <select class="styledselect_form_1" name="idDiemDi">
                                                        <c:forEach var="i" items="${listDiem}">
                                                            <option value="${i.idDiaDiem}">${i.tenDiaDiem}</option>
                                                        </c:forEach>
                                                    </select>
                                                </td>
                                            </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="date" class="form-control1" id="focusedinput" name="ngayKhoiHanh" maxlength="100" value="${ngayKhoiHanh}">
                                        </div>
                                        <div class="col-sm-2">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="date" class="form-control1" id="focusedinput"  name="ngayKetThuc" maxlength="100" value="${ngayKetThuc}">
                                        </div>
                                        <div class="col-sm-2">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <textarea  class="form-textarea" name="moTaNgan" style="width: 100%; height: 100px; " maxlength="500">${moTaNgan}</textarea>
                                        </div>
                                        <div class="col-sm-2">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <td><textarea class="form-textarea" id="moTaChiTiet" name="moTaChiTiet">${moTaChiTiet}</textarea></td>
