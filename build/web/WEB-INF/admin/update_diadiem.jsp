    ...
    <body class="cbp-spmenu-push">
        <%
            ...
            if (request.getParameter("id") != null) {
                str = (String) request.getParameter("id");
            }
        %>
            ...
            <jsp:include page="header.jsp"></jsp:include>
                <div id="page-wrapper">
                    <div class="main-page">
                        <div class="forms">
                            <div class="row">
                                <h3 class="title1">Cập nhật địa điểm</h3>
                                <div class="form-three widget-shadow">
                                    <form action="${pageContext.request.contextPath}/admin/diadiem/update" class="form-horizontal" method="POST">
                                    <div class="form-group">
                                        <label for="focusedinput" class="col-sm-2 control-label">Tên địa điểm:</label>
                                        <div class="col-sm-8">
                                            <input name="tenDiaDiem" value="${dd.tenDiaDiem}" type="text" class="form-control1" id="focusedinput" placeholder="Nhập tên địa điểm">
                                        </div>
                                        <div class="col-sm-2">
                                            <p style="color: red" class="help-block">${s}</p>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="focusedinput" class="col-sm-2 control-label"></label>
                                        <div class="col-sm-8">
                                            <input type="hidden" value="${dd.idDiaDiem}" name="idDiaDiem" />
                                            <input type="submit" value="Cập nhật dữ liệu"  />
                                            <a href="${pageContext.request.contextPath}/admin/diadiem/index">Quay lại trang quản lý</a>
                                        </div>
                                        <td></td>
                                    </div>
                                </form>
