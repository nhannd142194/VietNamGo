            ...
            <jsp:include page="header.jsp"></jsp:include>
                <div id="page-wrapper">
                    <div class="main-page">
                        <div class="forms">
                            <div class="row">
                                <h3 class="title1">Thêm địa điểm</h3>
                                <div class="form-three widget-shadow">
                                    <form action="${pageContext.request.contextPath}/admin/diadiem/insert" class="form-horizontal" method="POST">
                                        <div class="form-group">
                                            <label for="focusedinput" class="col-sm-2 control-label">Tên địa điểm:</label>
                                            <div class="col-sm-8">
                                                <input name="tenDiaDiem" type="text" class="form-control1" id="focusedinput" placeholder="Nhập tên địa điểm">
                                            </div>
                                            <div class="col-sm-2">
