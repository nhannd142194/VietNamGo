                        ...
                        <div class="forms">
                            <div class="row">
                                ...
                                <div class="form-three widget-shadow">
                                    <form class="form-horizontal" action="${pageContext.request.contextPath}/admin/news/insert" 
                                      method="post" enctype="multipart/form-data">
                                    <div class="form-group">
                                        <label for="focusedinput" class="col-sm-2 control-label">Tiêu đề bài viết:</label>
                                        <div class="col-sm-8">
                                            <input type="text" class="form-control1" id="focusedinput" placeholder="Nhập Tên Tin Tức" name="tenTinTuc" maxlength="100" value="${tenTinTuc}">
                                        </div>
                                        <div class="col-sm-2">
                                                ...
                                                <td>
                                                    <select class="styledselect_form_1" name="idLoaiTen">
                                                        <c:forEach var="i" items="${listLoaiTin}">
                                                            <option value="${i.idLoaiTen}">${i.tenLoai}</option>
                                                        </c:forEach>
                                                    </select>
                                                </td>
                                            </div>
