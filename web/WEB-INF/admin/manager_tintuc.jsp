                    ...
                    <div class="main-page">
                        <div class="tables">
                            <div class="table-responsive bs-example widget-shadow">
                                <h4>Danh Sách Tin Tức</h4> <a href="${pageContext.request.contextPath}/admin/news/insert">Thêm mới</a>
                                ...
                                <tbody>
                                    ...
                                    <c:forEach var="t" items="${listNews}">
                                        ...
                                        <tr> 
                                            ...
                                            <td>${t.tenTinTuc}</td>
                                            <td><img width="200px" src="${pageContext.request.contextPath}/admin/news/img?id=${t.idTinTuc}" alt="" /></td> 
                                            <td style="width: 100px">${t.loaiTin.tenLoai}</td>
                                            <td style="width: 100px">${t.ngayDang}</td> 
                                            <td>${t.user.hoTen}</td> 
                                            <td style="width: 100px"><a href="${pageContext.request.contextPath}/admin/news/update?id=${t.idTinTuc}">Sửa</a> | <a href="${pageContext.request.contextPath}/admin/news/delete?id=${t.idTinTuc}">Xóa</a></td> 
                                        </tr>
                                    </c:forEach>
